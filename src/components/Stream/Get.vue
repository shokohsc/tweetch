<template>
  <div v-if="!loading" class="container fluid pt-6">
    ...
    <h2 class="subtitle has-text-centered has-text-white">{{ stream.user }}<small> plays <router-link :to="stream.categoryRoute">{{ stream.category }}</router-link> for {{ stream.viewers }} viewers</small></h2>
